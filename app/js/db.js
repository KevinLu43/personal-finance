...
const DB_VERSION = 3; // bumped for the 'recurringTransactions' store

const STORES = ['accounts', 'categories', 'labels', 'transactions', 'transactionLabels', 'investments', 'recurringTransactions'];
